                ...
                >
                    <VStack align="flex-start" gap={6} maxW="600px" mb={{ base: 12, lg: 0 }}>
                        ...
                        <Text fontSize="xl" color="gray.500">
                            View your currently playing tracks, browse your listening history,
                            create playlists from your recently played songs, and discover your top
                            artists and tracks.
                        </Text>
                        ...
                        <Text fontSize="sm" color="gray.500" mt={4}>
                            Powered by the Spotify Web API. You'll need a Spotify account to use
                            this application.
                        </Text>
                    </VStack>
