...
const CurrentlyPlayingPage = () => {
  ...
  useEffect(() => {
    if (currentlyPlaying?.is_playing && currentlyPlaying?.progress_ms && currentlyPlaying?.item) {
        ...
        {loadingCurrent ? (
            ...
            <VStack align="flex-start" gap={4} flex="1">
              <Box>
                ...
                <Text color="gray.500" mt={1}>
                  ...
                  {new Date(currentlyPlaying.item.album.release_date).getFullYear()}
                </Text>
              </Box>
              ...
              {/* Playback Status */}
              <Badge colorScheme={currentlyPlaying.is_playing ? 'green' : 'gray'} mt={2}>
          ...
          <Center py={10}>
            <VStack>
              ...
              <Text color="gray.500">Start playing a track on Spotify to see details here</Text>
            </VStack>
          </Center>
        )}
      </Box>
